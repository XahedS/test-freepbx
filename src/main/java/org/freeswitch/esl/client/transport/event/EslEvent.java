 ...
 * <p/>
 * The messageHeader lines from the original message are cached in a map keyed by {@link Name}.
 *
...
public class EslEvent {
	 ...
	 * The message headers are stored in a map keyed by {@link Name}. The string mapped value
